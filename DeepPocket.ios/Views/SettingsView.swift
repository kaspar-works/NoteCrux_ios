                        ...
                        VStack(alignment: .leading, spacing: 11) {
                            ...
                            ProfileCard {
                                ProfileToggleRow(
                                    ...
                                    title: "App Lock",
                                    subtitle: "Use Face ID to secure DeepPocket",
                                    isOn: $appLockEnabled
                                )
                            }
                        }
...
private struct PrivacyGuaranteeCard: View {
    var body: some View {
        VStack(spacing: 13) {
            ...
            Text("DeepPocket is local-first encryption. Your financial data never leaves this device without your permission.")
